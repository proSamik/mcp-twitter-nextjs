...
export interface TweetListRef {
  refreshTweets: () => void;
}

export const TweetList = forwardRef<TweetListRef, TweetListProps>(
  ({ userId }, ref) => {
    ...
    // Expose refreshTweets method to parent component
    useImperativeHandle(ref, () => ({
      refreshTweets: () => fetchTweets(currentPage),
    }));
